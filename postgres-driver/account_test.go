	...
	}{
		{
			...
			users: map[types.UserID]types.AccountUserAccess{
				"user_1": {
					...
					Owner:    true,
					Accepted: true,
					ProviderUserIDs: map[types.AuthType]types.ProviderUserID{
	...
	tests := []struct {
		...
		},
		{
			...
			accountUsersAfterUpdate: map[types.UserID]types.AccountUserAccess{
				...
				"user_10": {UserID: "user_10", Email: "daenerys.targaryen123@test.com",
					//  RoleName: types.RoleAdmin,
					Accepted: false},
			},
			testCreatedTime: testdata.MockTimestamp,
	...
	}{
		{
			...
			accountUsers: map[types.UserID]types.AccountUserAccess{
				...
				"user_10": {
					...
					// RoleName: types.RoleAdmin,
					Accepted:        true,
					ProviderUserIDs: map[types.AuthType]types.ProviderUserID{types.AuthTypeAuth0Username: "auth0|daenerys_targaryen"},
				},
			},
			err: nil,
		},
